...
\begin{figure}[h!]
    ...
    \subfigure[并排小图a]{
        \label{fig-sub-l}
        \includegraphics[width=.2\textwidth]{preset/figure/logo.eps}
    }
    \hspace{7em} % 水平间隔
    \subfigure[并排小图b]{
        \label{fig-sub-r}
        \includegraphics[width=.2\textwidth]{preset/figure/logo.jpg}
    }
    \caption{子图并排的示例}
    \label{fig-sub}
\end{figure}
...
\begin{figure}[h!]
    ...
    \begin{tabular}{cc}
        \subfigure[矩阵子图A]{
            \label{fig-matrix-a}
            \includegraphics[width=.18\textwidth]{preset/figure/logo.eps}
        } \hspace{7em} &
        \subfigure[矩阵子图B]{
            \label{fig-matrix-b}
            \includegraphics[width=.18\textwidth]{preset/figure/logo.eps}
